...
const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.WORKSPACE.REPORT_FIELDS_CREATE_INITIAL_VALUE]: () => require<ReactComponentModule>('../../../../pages/workspace/reports/WorkspaceReportFieldsCreateInitialValuePage').default,
